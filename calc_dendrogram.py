...
def calc_dendrogram(data,sigma,delta,ppb, save=False,fout='temp'):
    # Survey designs
    # sigma - K, noise level
    # ppb  - pixels/beam
    ...
    d = Dendrogram.compute(data, min_value=sigma, \
                            min_delta=delta*sigma, min_npix=1.*ppb, \
...
def main(args):
    ...
    d = calc_dendrogram(data,args.sigma,args.delta,args.ppb,save=True,fout=args.file_out)
